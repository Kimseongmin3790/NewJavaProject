...
//		}
		...
		for(int i=0; i<arr.length -1 ; i++) { // 0,1,2,3,4, -> 1,2,3,4, -> 2,3,4 -> 3,4 -> 4
			for(int j=0; j<arr.length-i-1; j++) { // 1,2,3,4 -> 2,3,4 -> 3,4 -> 4
				if (arr[j] > arr[j+1]) { // arr[1,2,3,4] < arr[0,1,2,3]
					int temp = arr[j]; // temp = 3
